...
export enum ErrorCode {
  ...
  DEEPSEEK_INVALID_API_KEY = 3010,
  DEEPSEEK_RATE_LIMIT_EXCEEDED = 3011,
  DEEPSEEK_CACHE_ERROR = 3012,
  DEEPSEEK_REASONING_FAILED = 3013,
  DEEPSEEK_COMPATIBILITY_ERROR = 3014,
  DEEPSEEK_TOKEN_CALC_ERROR = 3015,
